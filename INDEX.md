...
Every video in the Drive `Footage` folder, subfolders included: **85 clips**,
each with a contact sheet and a transcode. 18.6 MB of sheets,
761.0 MB of video.
...
> ### Faces
>
> `cleared` and `**FACE**` are the hub's verdicts, 29 of 85 so far.
