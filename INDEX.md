...
Every video in the Drive `Footage` folder, subfolders included: **90 clips**,
each with a contact sheet and a transcode. 19.4 MB of sheets,
773.4 MB of video.
...
> ### Faces
>
> `cleared` and `**FACE**` are the hub's verdicts, 29 of 90 so far.
