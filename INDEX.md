...
Every video in the Drive `Footage` folder, subfolders included: **87 clips**,
each with a contact sheet and a transcode. 19.0 MB of sheets,
765.4 MB of video.
...
> ### Faces
>
> `cleared` and `**FACE**` are the hub's verdicts, 29 of 87 so far.
