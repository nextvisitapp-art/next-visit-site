...
BEATS = [
    ( 1.20, 2.30),   # the header: what Little Things is
    (21.40, 3.20),   # her tab: ring size, metal, stone, the proposal note
    (27.60, 2.80),   # her favourites and how she feels loved
    (30.20, 2.40),   # the tail, end card lands here. Do NOT go past 32.8:
...
<div class="plate" id="p1"><h1>Ask her ring size,<br>she'll <em>know why.</em></h1></div>
<div class="plate" id="p2"><h1 class="lg">So <em>don't ask.</em></h1></div>
<div class="plate" id="p3"><div class="eyebrow">She wrote it herself</div>
  <h1 class="lg">Months <em>ago.</em></h1></div>
...
const B=[{B[0]:.4f},{B[1]:.4f},{B[2]:.4f},{B[3]:.4f}];
...
window.setT=function(t){{
  ...
  plate('p2',t,B[1]+0.16,B[2]-0.04,0.26);
  plate('p3',t,B[2]+0.16,B[3]+0.18,0.26);
  const oe=ss(cl(B[3]+0.55,B[3]+1.45,t));
